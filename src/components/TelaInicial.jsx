    ...
    <div style={{
      ...
      <style>{`
        ...
        .login-box {
          ...
          width: 100%;
          max-width: 380px;
          box-shadow: 0 15px 35px rgba(44, 22, 58, 0.25);
          display: flex;
        ...
        /* LOGO DE FUNDO RESPONSIVA: Mais larga no desktop, controlada no celular */
        .fundo-logo {
          width: 100%;
          height: 100%;
          background-image: url("/imagens/logo-telainicial.jpeg"), url("./imagens/logo-telainicial.jpeg");
          background-size: 835px auto; /* Tamanho mais largo e imponente para computadores */
          background-position: center;
          background-repeat: no-repeat;
        }

        /* Se a tela for de celular (menor que 768px), ajusta para a logo não estourar nem quebrar */
        @media (max-width: 768px) {
          .fundo-logo {
            background-size: 90% auto; /* Proporcional à largura do celular, evitando cortes */
          }
          .login-box {
            max-width: 320px;
            padding: 20px 18px;
      ...
      <div className="login-container-embaçado">
        <div className="login-box" onClick={(e) => e.stopPropagation()}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '18px' }}>
            ...
            <span style={{ fontSize: '11px', color: '#666666', fontFamily: "'Montserrat', sans-serif" }}>
          ...
          <form onSubmit={handleLoginSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              <label htmlFor="login-nome" style={{ fontFamily: "'Cinzel', serif", color: '#C8A24A', fontSize: '11px', fontWeight: 700 }}>
                NOME COMPLETO
              </label>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <MdPerson size={18} color="#C8A24A" />
                <input
                  type="text"
                  id="login-nome"
                  value={nomeCompleto}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              <label htmlFor="login-senha" style={{ fontFamily: "'Cinzel', serif", color: '#C8A24A', fontSize: '11px', fontWeight: 700 }}>
                SENHA 
              </label>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <MdLock size={18} color="#C8A24A" />
                <input
